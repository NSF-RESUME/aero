...
def upgrade():
    ...
    with op.batch_alter_table("provenance", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            None, "source_version", ["source_version_id"], ["id"]
        )
    ...
    with op.batch_alter_table("provenance_derivation", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(
            "provenance_derivation_previous_proxy_id_fkey", type_="foreignkey"
        )
        batch_op.create_foreign_key(
            None, "source_version", ["previous_source_version_id"], ["id"]
        )
...
def downgrade():
    ...
    with op.batch_alter_table("provenance_derivation", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "previous_proxy_id", sa.INTEGER(), autoincrement=False, nullable=True
            )
        )
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            "provenance_derivation_previous_proxy_id_fkey",
            "proxy",
            ["previous_proxy_id"],
            ["id"],
        )
    ...
    with op.batch_alter_table("provenance", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_="foreignkey")
        batch_op.create_foreign_key(
            "provenance_proxy_id_fkey", "proxy", ["proxy_id"], ["id"]
        )
