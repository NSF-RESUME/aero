"""Major db refactoring with some bug fixes

Revision ID: b8bba8d7950a
Revises:
Create Date: 2025-02-21 17:43:41.877671
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("pull_function_id", sa.Uuid(), nullable=True),
        sa.Column("commit_function_id", sa.Uuid(), nullable=True),
        ...
        sa.Column("arg_hash", sa.String(), nullable=True),
        sa.ForeignKeyConstraint(
            ["function_id"],
            ["function.id"],
        ),
